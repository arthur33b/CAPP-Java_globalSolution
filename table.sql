...
DROP TABLE TB_COURAPP_ALUNO  CASCADE CONSTRAINTS;
...
CREATE TABLE TB_CAPP_AULA (
    ...
    TB_COURAPP_ALUNO_ID_aluno        INTEGER       NOT NULL,
    ...
    CONSTRAINT TB_CAPP_AULA_TB_COURAPP_ALUNO_FK
        FOREIGN KEY (TB_COURAPP_ALUNO_ID_aluno)
        REFERENCES TB_COURAPP_ALUNO (ID_aluno)
);
